 ...
 * @var array<string, mixed> $movie Movie data to edit
...
$getValue = function (string $field) use ($movie): string {
    $oldValue = old($field);
    if ($oldValue !== '') {
        return $oldValue;
    }
    return h((string)($movie[$field] ?? ''));
};
?>
    ...
    <div class="col-lg-8">
        <div class="card shadow-sm">
            <div class="card-body p-4">
                <form action="/admin/movies/<?= (int)$movie['id'] ?>" method="POST">
                    <?= csrfField() ?>
                    ...
                    <div class="d-flex gap-2">
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-check-lg me-1"></i>Update Movie
                        </button>
