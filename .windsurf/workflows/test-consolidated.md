---
description: Run consolidated/grouped tests
---

# Run Consolidated Tests

Use the `@playwright-test-runner` skill to execute grouped tests.
...
// turbo
3. Run consolidated tests with 4 workers:
```powershell
npx playwright test consolidated.spec.ts --workers=4 --reporter=list
```
